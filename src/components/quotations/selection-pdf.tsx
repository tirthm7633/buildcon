...
const BRAND_PARTNERS = [
  { name: "GROHE", tagline: "Pure Freude an Wasser" },
  { name: "hansgrohe", tagline: "Life is Waterful" },
  { name: "AXOR", tagline: "Form Follows Perfection" },
  { name: "VitrA", tagline: "Design Meets Life" },
  { name: "NEXION", tagline: "The Surface Experience" },
  { name: "QUTONE", tagline: "Let's Build Together" },
  { name: "DIMORE", tagline: "Reflection of Your Style" },
  { name: "Oyster", tagline: "Indulge in Luxury" },
  { name: "GEBERIT", tagline: "Engineered for Hygiene" },
  { name: "MCM ITTIMI", tagline: "Innovation into Inspiration" },
  { name: "VERANTES LIVING", tagline: "Kitchens & Wardrobes" },
  { name: "IMPORTED FURNITURE", tagline: "Crafted Beyond Borders" },
];
